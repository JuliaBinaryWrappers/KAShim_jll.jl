# Autogenerated wrapper script for KAShim_jll for x86_64-apple-darwin14
export libkashim
...
const libkashim_splitpath = ["lib", "libkashim.dylib"]
...
const libkashim = "@rpath/libkashim.dylib"
