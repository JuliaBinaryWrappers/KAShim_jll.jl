...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import KAShim_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("652de3ec-ffb6-5c91-88b5-9e9ede6ab7e4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "KAShim", artifacts_toml) for e in artifacts["KAShim"]]
...
if best_platform === nothing
    @debug("Unable to load KAShim; unsupported platform $(triplet(platform_key_abi()))")
else
